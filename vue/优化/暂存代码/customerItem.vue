...
<template v-if="showCustoms">
  <div class="customsBox" v-if="customerItem.customs && (
    ...
    <div class="ellipsis">
      ...
      <!-- 次 -->
      <span :title="(customerItem.customs.customsCount && customerItem.customs.customsMoney != '' ? customerItem.customs.customsCount : '0') + $t('mxpcweb.client.customerItem.1555055730497')"> | {{customerItem.customs.customsCount && customerItem.customs.customsMoney != '' ? customerItem.customs.customsCount : '0'}}{{$t('mxpcweb.client.customerItem.1555055730497')}}</span>
    </div>
    <div style="color:#606266;margin-top: 7px;">
      <!-- 最近 -->
      <!-- 暂无 -->
      <span>{{$t('mxpcweb.client.customerItem.1555055806945')}}:</span><span>{{customerItem.customs.customsLastDate ? customerItem.customs.customsLastDate : $t('mxpcweb.client.customerItem.1555055810283')}}</span>
    </div>
  </div>
