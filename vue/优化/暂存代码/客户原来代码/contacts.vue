                                        ...
                                        <div>
                                            <div style="display:inline-block;width:100%">
                                                <span class="ellipsis" style="display:inline-block;text-align:left" :style="{'width':(75/5.3)+'%'}">
                                                    <template v-if="list.decisionMaker != '' && list.decisionMaker !== undefined&&checkIsShow('decisionMaker')" :title="list.decisionMaker">
                                                        <component v-bind:is="'control2'" ref="control" :value="{value:list.decisionMaker}" :itemData="{
                                                            dictCode: 200,
                                                ...
                                                <span class="ellipsis" style="display:inline-block;text-align:left" :style="{'width':(75/5.3)+'%'}">
                                                    <template v-if="list.intimacy != '' && list.intimacy !== undefined&&checkIsShow('intimacy')" :title="list.intimacy">
                                                        <component v-bind:is="'control71'" ref="control" :value="{value:list.intimacy}"></component>
                                                    </template>
                                                    <span v-else>&nbsp;</span>
                                                </span>
                                                <span class="ellipsis" style="display:inline-block;text-align:left" :style="{'width':(75/5.3)+'%'}">
