            ...
            <el-col :span="18" style="margin-top: -3px;">
              <div>
                <div style="display:inline-block;width:100%;">
                  ...
                  <!-- 标签 -->
                  <show-label :title="$t('mxpcweb.client.1529057053276')" style="overflow:hidden;height:20px;text-align:right" :style="{'width':(41+60/3.2)+'%'}" :moduleCode="moduleCode" ref="label" :dynamicTags="dynamicTags" :tags="contactItem.tags"></show-label>
                </div>
              </div>
            </el-col>
          </el-row>
