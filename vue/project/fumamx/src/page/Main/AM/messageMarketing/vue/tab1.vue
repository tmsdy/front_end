<template>
    <div class="tabitem">
        <div v-if="tabData==='1'" class="sendeeBox">
            <div class="sendeeBoxSearch">
                <div class="addButtonBox">
                    <el-button class="addButton" type="primary" @click="tabData='2'" size="small">新建短信</el-button>
                </div>
                <el-input class="addInput" v-model="keywords" placeholder="短信名称" icon="search"></el-input>
            </div>

            <div class="sendeeBoxList">
                <el-row class="list" :gutter="20">
                    <el-col :span="4">任务名称</el-col>
                    <el-col :span="2">请求</el-col>
                    <el-col :span="2">送达</el-col>
                    <el-col :span="2">处理失败</el-col>
                    <el-col :span="2">发送失败</el-col>
                    <el-col :span="2">计费条数</el-col>
            ...
            <div class="sendeeBoxList sendeeBoxTit MXscroll" :style="blockData.total>blockData.pageSize?'padding-bottom: 44px;':'padding-bottom: 0;'">
                ...
                <el-row v-else class="list1" :gutter="20" v-for="(item,index) in sendeeList" :key="index">
                    ...
                    <el-col :span="4">更新时间</el-col>
                    <el-col :span="4">
                        <span class="text-hover" @click="detailData=item;tabData='3'">编辑</span>
        ...
        <add-name v-if="tabData==='2'"></add-name>
