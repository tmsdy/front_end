...
<template>
    <div class="tabSendset" v-loading="loading">
        <div class="add">
            <!-- 添加发件人 -->
            <el-button type="primary" @click="$emit('openAddSendPeople','0')">{{$t('mxpcweb.am.1531903046900')}}</el-button>
        </div>
        <div class="tableBox">
            <el-row class="title">
                <el-col :span="8">
...
export default {
    ...
    methods: {
        ...
        deleteItem(item) {
            ...
            // 确定
            // 取消
            this.$confirm(this.$t('mxpcweb.am.1531904590171') + '（' + item.name + '）,' + this.$t('mxpcweb.am.1531904306656'), this.$t('mxpcweb.am.1531893166645'), {
