<template>
    <div class="RemindNotify">
        <el-dialog v-dialogDrag title="提醒通知" custom-class="width720" :visible.sync="dialogVisible" size="small" :before-close="close">
            ...
            <div class="notifyListBox">
                ...
                <div class="bodyBox MXscroll">
                    <el-checkbox-group v-model="checkList">
                        <el-row v-if="!isLoading&&dataList.length>0" v-for="(item,index) in dataList" :key="index" class="row">
                            <el-col class="item checkBoxItem ellipsis" :span="6">
                                <el-checkbox :disabled="disableCheck.includes(item.detailActionId)" class="checkbox" :label="item"></el-checkbox> {{item.subject}}
                            </el-col>
