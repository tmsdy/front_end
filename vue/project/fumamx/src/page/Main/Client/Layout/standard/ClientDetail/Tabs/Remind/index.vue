<template>
    <div class="Remind">
                        ...
                        <li :key="index2" v-else>
                            ...
                            <div class="operation">
                                ...
                                <span :title="$t('mxpcweb.client.detail.1529998909130')">
                                    <i class="iconfont icon-time" @click="delayMsgClick(item2)"></i>
                                </span>
                                <!-- 删除 -->
        ...
        <!-- 新增提醒 -->
        <fly-button @flyBtnClick="$emit('flyBtnClick', itemData.bindModuleCode, 'otReminder')" :fly="false" :title="$t('mxpcweb.client.detail.1529999452139')" :mainObj="mainObj"></fly-button>
    </div>
</template>
    ...
    methods: {
        ...
        getTabData() {
            var p0 = new Promise((resolve, reject) => {
                ...
                this.$http.get(this.Global.baseURL + this.Global.api.v2.message_get, { params: data }).then(function (res) {
            ...
            var p1 = new Promise((resolve, reject) => {
                ...
                this.$http.get(this.Global.baseURL + this.Global.api.v2.messenger_get, { params: data }).then(function (res) {
                    if (res.body.code.toString() === this.Global.RES_OK && res.body.data) {
                        resolve(res.body.data)
                    }
                }, function (res) {
        ...
        deleteScheduleClick(item) {
            ...
            this.$confirm(c, t, {
                ...
                this.$http.delete(this.Global.baseURL + this.Global.api.v2.messenger_delete, { params: { jobName: item.jobName } }).then(function (res) {
        ...
        delaySchedule() {
            ...
            this.$http.put(this.Global.baseURL + this.Global.api.v2.messenger_put, data).then(function (res) {
                if (res.body.code.toString() === this.Global.RES_OK) {
        ...
        messagePut(data) {
            // console.log(data)
            this.$http.put(this.Global.baseURL + this.Global.api.v2.message_put, data).then(function (res) {
                if (res.body.code.toString() === this.Global.RES_OK) {
                    this.dialogVisible = false
                    this.$message.success(this.msg(res.body))
                    this.getTabData()
