        ...
        <transition name="slider-customer">
            <div class="sliderBody" :class="windowMode ? 'windowMode' : ''" v-if="isOpen" v-loading="loading">
                ...
                <div class="body MXscroll" ref="mailDetail">
                    <detail-right :DetailDataList="DetailDataList" :content="content" ref="detail-right" :isSlider="true" @OperationTrigger="OperationTrigger" :fullShow="false"></detail-right>
                </div>
            </div>
        </transition>
