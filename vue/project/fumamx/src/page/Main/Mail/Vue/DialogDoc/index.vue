<template>
    <div class="DialogDoc">
        <!-- 选择文档 -->
        <el-dialog :title="$t('mxpcweb.document.global.1532682270147')" :visible.sync="isOpen" :modal-append-to-body="false" v-dialogDrag :close-on-click-modal="false" >
            <div class="tabBox">
                <ul class="clearfix">
            ...
            <div slot="footer" class="dialog-footer clearfix">
                ...
                <!-- 选取 -->
                <el-button class="pull-right" type="primary" @click="commit()">{{$t('mxpcweb.document.global.1531890795642')}}{{checkedDocs.length>0?` (${checkedDocs.length})`:''}}</el-button>
...
export default {
    ...
    methods: {
        ...
        commit() {
            ...
            let tempCheckedDocs = this.checkedDocs.reduce((arr, item) => {
