...
import TemplateSettings from '../../../SystemSet/PrintTemplateManagement/Dialog/TemplateSettings/index'
import OnlineReportDesigner from '../../../SystemSet/PrintTemplateManagement/Dialog/OnlineReportDesigner/index'
export default {
    name: 'systemList',
    props: {
        activeName: {
    ...
    methods: {
        ...
        addTemplate() {
            this.$refs.TemplateSettings.showOpenVisible(this.activeName, '0')
        },
        editTemplte(obj) {
            ...
            _this.$http.get(_this.Global.baseURL + _this.Global.api.v2.reportManage, { params: params })
                .then(function (res) {
                    if (res.body.code.toString() == _this.Global.RES_OK) {
                        this.$refs.OnlineReportDesigner.showOpen('copy', row, true)
                    } else {
