<template>
    <div>
        <el-dialog v-dialogDrag :title="titleName" custom-class="width620" :visible.sync="Visible" @close="resetForm('form')">
        ...
        <el-dialog v-dialogDrag title="请选择预览数据" custom-class="width620" :visible.sync="checkVisible" @close="resetForm('form2')">
            <el-form ref="form2" label-width="190px" style="margin: 5px 10px; ">
                ...
                <el-form-item label="合同单号" v-if="form.moduleCode=='SC002'">
                    <el-select v-model="form.value" placeholder="请选择">
