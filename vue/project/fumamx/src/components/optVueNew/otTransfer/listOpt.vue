<template>
    <!-- 客户负责人转移 -->
    <el-dialog v-dialogDrag :title="$t('mxpcweb.client.1529054059107')" :visible.sync="dialogSetList" :closeOnClickModal="false" custom-class="width620">
        <div class="addShare">
            <div class="customer" style="font-size:16px;" v-if="custNames.length!=0">
                <!-- 客户 -->
                <div class="customerTitle">{{$t('mxpcweb.client.1529049476377')}}：</div>
            ...
            <div class="customer">
                ...
                <el-select v-model="select" filterable placeholder="" @change="getTreeList"  style="width:380px;margin-left:100px;">
                    ...
                    <div v-for="(item,index) in personnelTable" :key="index"  v-show="item.inUse">
            ...
            <div class="customer">
                ...
                <!-- <div v-if="itemData.cooperate&&itemData.cooperate.length!==1">
                    <el-checkbox style="width:380px;margin:9px 0 0 100px;" v-model="transferList1">同时移交共享协作人</el-checkbox>
...
export default {
    ...
    methods: {
        // 打开窗口
        openWindow(obj) {
            let {billId, customerLists, optData, next} = obj
            ...
            this.billId = billId
            let _this = this
            this.billId.forEach(function(item) {
