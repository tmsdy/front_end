  ...
  <header class="header">
    ...
    <div class="navbar">
      <div class="navbar-left-container">
        <a href="/">
          <img class="navbar-brand-logo" src="static/shopping.png"></a>
      </div>
          ...
          <div class="confirm-tips">
            ...
            <ul>
              <li class="regi_form_input">
                ...
                <input type="text" tabindex="1" v-model="user_name" name="loginname" placeholder="User Name" data-type="loginname" class="regi_login_input regi_login_input_left">
              </li>
              <li class="regi_form_input noMargin">
                <i class="icon IconPwd"></i>
                <input type="password" tabindex="2" v-model="user_password" name="password" @keyup.enter="login" placeholder="Password" class="regi_login_input regi_login_input_left login-input-no input_text">
              </li>
            </ul>
          </div>
          ...
          login(){
            ...
            axios.post('/api/users/login',{
              ...
              if(res.data.code==0){
                ...
                this.getCartCount() ;
                this.nickName = res.data.userInfo.user_name ;
                window.location.reload() ;
              }
            })
          },
        logOut(){
          this.setCookie('userInfo',null,0) ;
          this.nickName = '' ;
          window.location.reload() ;
        },
        getCartCount(){
            axios.get("/api/goods/getCartCount").then(res=>{
              console.log(res) ;
            })
        }
      }
