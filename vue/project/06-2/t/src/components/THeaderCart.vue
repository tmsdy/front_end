                                    ...
                                    <div class="cart-item-inner">
                                        ...
                                        <div class="item-desc">
                                            <div class="cart-cell">
                                                ...
                                                <h6>
                                                    <span class="price-icon">¥</span><span class="price-num">{{(cart.price/ 100).toFixed(2)}}</span><span class="item-num">x {{cart.quantity}}</span>
                                                </h6>
                                            </div>
                                        </div>
...
<script>
    export default {
        ...
        computed: {
            carts() {
                // this.$store.state.carts.reduce(function(prev, item) {
                //     return {
                //         quantity: prev.quantity + item.quantity,
                //         price: prev.price + (item.quantity * item.price)
                //     };
                // }, {
                //     quantity: 0,
                //     price: 0
