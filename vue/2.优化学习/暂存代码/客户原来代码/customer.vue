 <template>
    <div class="customerLists">
                                            ...
                                            <div v-if="list.dynamics" class="track" :title="JSON.parse(list.dynamics).content">
                                                <div class="ellipsis" v-if="!isNaN(parseInt(JSON.parse(list.dynamics).type))">
                                                    ...
                                                    <span class="trackName">
                                                        ...
                                                        <!-- 跟进动态 -->
                                                        <el-popover ref="elPopover" v-if="list.custTracksData&&list.custTracksData.length>0" placement="bottom" :title="$t('mxpcweb.client.1529057099070')" width="400" trigger="hover">
        ...
        <!-- 查看更多 -->
        <div v-if="list.custTracksData.length>5" @click="listaddTab(list)" class="text-hover" style="text-align:center">
