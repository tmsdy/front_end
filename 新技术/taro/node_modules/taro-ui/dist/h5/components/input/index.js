    ...
    return <View className={classNames({
      ...
      'at-input--without-border': !border
        ...
        'at-input--disabled': disabled
          ...
          {title ? <Label className="at-input__title" for={name}>{title}</Label> : null}
          <Input className="at-input__input" id={name} name={name} type={type} placeholderStyle={placeholderStyle} placeholderClass={classNames('placeholder', placeholderClass)} placeholder={placeholder} cursorSpacing={cursorSpacing} maxlength={maxlength} autoFocus={autoFocus} focus={focus} value={value} confirmType={confirmType} cursor={cursor} selectionStart={selectionStart} selectionEnd={selectionEnd} adjustPosition={adjustPosition} disabled={disabled} onInput={this.onInput.bind(this)} onFocus={this.onFocus.bind(this)} onBlur={this.onBlur.bind(this)} onConfirm={this.onConfirm.bind(this)} />
          {clear && value ? <View className="at-input__icon" onTouchStart={this.clearValue.bind(this)}>
                <AtIcon customStyle={{ fontSize: '15px' }} value="close-circle" color="#ccc" />
              </View> : null}
          {error ? <View className="at-input__icon" onTouchStart={this.onErrorClick.bind(this)}>
