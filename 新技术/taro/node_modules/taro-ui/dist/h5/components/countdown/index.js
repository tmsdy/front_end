...
export default class AtCountDown extends AtComponent {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.day === props.day && nextProps.hours === props.hours && nextProps.minutes === props.minutes && nextProps.seconds === props.seconds) return;
  ...
  render() {
    ...
    return <View className={classNames({
      ...
      'at-count-down--card': isCard
        ...
        {isShowDay ? <View className="at-count-down__item">
