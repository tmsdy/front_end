    ...
    return <View className={rootClass} onClick={this.handleClick}>
        <View className="at-list__item-container">
          ...
          {iconInfo.value ? <View className="at-list__item-icon item-icon">
              <AtIcon customStyle={this.mergeStyle({ fontSize: `${iconInfo.size || 24}px` }, iconInfo.customStyle)} value={iconInfo.value} color={iconInfo.color} className={iconInfo.className} prefixClass={iconInfo.prefixClass} />
            </View> : null}
