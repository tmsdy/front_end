  ...
  render() {
    ...
    return <View className={classNames({
      ...
      'at-input-number--lg': size
        ...
        <View className={inputValue <= min || disabled ? 'at-input-number__btn at-input-number--disabled' : 'at-input-number__btn'} onClick={this.handleMinus.bind(this)}>
          <AtIcon customStyle={{ fontSize: '18px' }} value="subtract" />
        </View>
        <Input className="at-input-number__input" style={inputStyle} type={type} value={inputValue} disabled={disabled} onInput={this.handleInput.bind(this)} onBlur={this.handleBlur.bind(this)} />
        <View className={inputValue >= max || disabled ? 'at-input-number__btn at-input-number--disabled' : 'at-input-number__btn'} onClick={this.handlePlus.bind(this)}>
