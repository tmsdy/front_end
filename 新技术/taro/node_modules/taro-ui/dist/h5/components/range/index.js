...
export default class AtRange extends AtComponent {
  ...
  render() {
    ...
    }, className)} style={customStyle} onClick={this.handleClick.bind(this)}>
        <View className="at-range__container" style={containerStyle} ref={this.getRangeRef}>
          ...
          <View style={this.mergeStyle(slider1Style, sliderStyle)} className="at-range__slider" onTouchMove={this.handleTouchMove.bind(this, 'slider1X')} onTouchEnd={this.handleTouchEnd.bind(this, 'slider1X')}>
          </View>
          <View style={this.mergeStyle(slider2Style, sliderStyle)} className="at-range__slider" onTouchMove={this.handleTouchMove.bind(this, 'slider2X')} onTouchEnd={this.handleTouchEnd.bind(this, 'slider2X')}>
          </View>
        </View>
      </View>;
  }
