...
export default class AtCalendar extends Taro.Component {
  ...
  setGenerateDate(vectorCount) {
    const { generateDate } = this.state;
    const _generateDate = dayjs(generateDate).add(vectorCount, 'month').valueOf();
    this.setState({
  ...
  render() {
    ...
    return <View className={classnames('at-calendar', className)}>
        ...
        <AtCalendarBody marks={marks} format={format} minDate={minDate} maxDate={maxDate} isSwiper={isSwiper} isVertical={isVertical} selectedDate={selectedDate} selectedDates={selectedDates} generateDate={generateDate} onDayClick={this.handleDayClick} onSwipeMonth={this.setGenerateDate} onLongClick={this.handleDayLongClick} />
      </View>;
  }
}
...
tslib_1.__decorate([bind], AtCalendar.prototype, "setGenerateDate", null);
