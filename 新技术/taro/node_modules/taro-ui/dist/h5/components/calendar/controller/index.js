...
export default class AtCalendarController extends Taro.Component {
  render() {
    ...
    return <View className="at-calendar__controller controller">
        ...
        <Picker className="controller__info" mode="date" fields="month" end={maxDateValue} start={minDateValue} onChange={this.props.onSelectDate} value={dayjsDate.format('YYYY-MM')}>
