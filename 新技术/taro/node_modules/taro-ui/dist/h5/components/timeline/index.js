...
export default class AtTimeline extends AtComponent {
  render() {
    ...
    const itemElems = items.map((item, index) => {
      ...
      return <View className={itemRootClassName} key={index}>
          ...
          <View className="at-timelineitem__content">
            ...
            {content.map((sub, subIndex) => <View className="at-timelineitem__content-item at-timelineitem__content--sub" key={subIndex}>
                  {sub}
                </View>)}
          </View>
        </View>;
