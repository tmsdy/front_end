                ...
                <View className="at-grid-item__content">
                  <View className="at-grid-item__content-inner">
                    <View className="content-inner__icon">
                      ...
                      {_isObject(childItem.iconInfo) && !childItem.image && <AtIcon customStyle={this.mergeStyle({ fontSize: `${childItem.iconInfo.size || 24}px` }, childItem.iconInfo.customStyle)} value={childItem.iconInfo.value} color={childItem.iconInfo.color} className={childItem.iconInfo.className} prefixClass={childItem.iconInfo.prefixClass} />}
                    </View>
