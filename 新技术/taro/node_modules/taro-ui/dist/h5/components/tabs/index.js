...
export default class AtTabs extends AtComponent {
  ...
  render() {
    ...
    const tabItems = tabList.map((item, i) => <View className={classNames({
      'at-tabs__item': true,
    ...
    return <View className={classNames({
      ...
      'at-tabs--vertical': tabDirection === 'vertical'
        ...
        {scroll ? <ScrollView id={this.tabId} className={classNames({
        'at-tabs__header': true,
        'at-tabs__header--scroll': scroll
      })} style={heightStyle} scrollX={tabDirection === 'horizontal'} scrollY={tabDirection === 'vertical'} scrollWithAnimation scrollLeft={scrollLeft} scrollTop={scrollTop} scrollIntoView={scrollIntoView}>
              {tabItems}
            </ScrollView> : <View id={this.tabId} className="at-tabs__header">
              {tabItems}
            </View>}
