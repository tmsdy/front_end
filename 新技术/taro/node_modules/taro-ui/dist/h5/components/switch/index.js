    ...
    return <View className={classNames({
      ...
      'at-switch--without-border': !border
        ...
        'at-switch--disabled': disabled
          ...
          {checked ? <Switch className="at-switch__switch" checked color={color} onChange={this.handleChange.bind(this)} /> : <Switch className="at-switch__switch" color={color} onChange={this.handleChange.bind(this)} />}
        </View>
      </View>;
  }
}