...
let html = '<div id="toggleShow" contenteditable="false" style="color: #007fff;height: 40px;line-height: 40px;">——隐藏原邮件——</div>'
var pattern = /<div id="toggleShow"[^>]+>[^<]+<\/div>/g
console.log()
// html.replace(html.match(pattern)[0], '')
console.log(html.replace(pattern, ''));
// console.log(html.replace('隐藏原邮件', ''));